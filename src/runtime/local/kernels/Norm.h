...
template <class DTRes, class DTArg> struct Norm {
...
template <class DTRes, class DTArg> void norm(DTRes *&res, const DTArg *arg, DCTX(ctx)) {
    Norm<DTRes, DTArg>::apply(res, arg, ctx);
}
...
template <typename VT> struct Norm<DenseMatrix<VT>, DenseMatrix<VT>> {
...
template <typename VT> struct Norm<DenseMatrix<VT>, CSRMatrix<VT>> {
...
template <typename VT> struct Norm<Matrix<VT>, Matrix<VT>> {
